...
namespace CMU462 { namespace StaticScene {
  ...
  class BVHAccel : public Aggregate {
    public:
	  ...
	  /*Create BVH tree recursively*/
	  void create_BVH(BVHNode* root, size_t max_leaf_size);

	  bool split_decision_node(BVHNode* root, double *plane_coord, int *dim);

	  /*Check for intersection recursively*/
	  void intersect_recursive(const Ray &ray, Intersection *i, BVHNode* root, bool& hit) const;
